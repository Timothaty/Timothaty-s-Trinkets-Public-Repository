...
public class CorruptedRosariumCurio implements ICurio {
	private final ItemStack stack;

	public CorruptedRosariumCurio(ItemStack stack) {
		this.stack = stack;
	}
	...
	public SoundInfo getEquipSound(SlotContext slotContext) {
		SoundEvent sound = DeferredHolder.create(
				Registries.SOUND_EVENT,
				ResourceLocation.parse("item.armor.equip_leather")
		).value();
