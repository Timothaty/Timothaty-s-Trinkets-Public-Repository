...
@OnlyIn(Dist.CLIENT)
public class SacrificeSuccesParticle extends TextureSheetParticle {
	...
	public static SacrificeSuccesParticleProvider provider(SpriteSet spriteSet) {
		return new SacrificeSuccesParticleProvider(spriteSet);
	}

	protected SacrificeSuccesParticle(ClientLevel level, double x, double y, double z,
	...
	@OnlyIn(Dist.CLIENT)
	public static class SacrificeSuccesParticleProvider implements ParticleProvider<SimpleParticleType> {
		private final SpriteSet spriteSet;

		public SacrificeSuccesParticleProvider(SpriteSet spriteSet) {
		...
		public Particle createParticle(SimpleParticleType type, ClientLevel level,
			...
			return new SacrificeSuccesParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
		}
	}
}