...
public class ItemArms {
	public static void renderPartWithArms(HierarchicalModel<Entity> model, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource bufferSource, int packedLight, int packedOverlay, PlayerModel<?> playerModel,
